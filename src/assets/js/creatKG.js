...
export default class creatGraph {
  ...
  constructor (container) {
    ...
    this.links = [
      { source: '节点1', target: '节点2', value: 1, relation: '关系1', color: 'black' },
      { source: '节点1', target: '节点2', value: 1, relation: '关系2', color: 'black' },
      { source: '节点1', target: '节点2', value: 1, relation: '关系3', color: 'black' },
      { source: '节点1', target: '节点2', value: 1, relation: '关系4', color: 'black' }
    ]
  ...
  drawGraph () {
    ...
    // 设置节点的title信息
    graphNode.append('title').style('width', 19).text(d => d.id)
